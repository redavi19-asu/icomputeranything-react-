...
export default function App() {
  ...
  // Merge base and mobile overrides
  const m = (base, mob) => (mobile ? { ...base, ...mob } : base);
  ...
  return (
    <>
            ...
            {sections.map((s, i) => (
              <button
                ...
                style={{
                  ...
                  background:
                    i === active ? "rgba(125,211,252,0.18)" : "rgba(255,255,255,0.04)",
                  color: i === active ? "#7dd3fc" : "white",
                  fontWeight: 750,
                  cursor: "pointer",
                  marginBottom: 8,
                }}
          ...
          <section key={s.key} style={m(styles.section, styles.sectionMobile)} className={s.key === "home" ? "home-section" : undefined}>
            {s.key === "home" ? (
              ...
              <div style={styles.aboutWrap}>
                <Reveal rootRef={scrollerRef} y={18}>
                  <div style={m(styles.aboutInner, styles.aboutInnerMobile)}>
                    ...
                    <div style={m(styles.aboutPills, styles.aboutPillsMobile)}>
                    ...
                    <div style={m(styles.aboutGrid, styles.aboutGridMobile)}>
                      {[
                        {
                          title: "What I do",
                          body:
                        ...
                        <div key={c.title} style={m(styles.aboutCard, styles.aboutCardMobile)}>
              ...
              <div style={styles.projectsWrap}>
                ...
                <div style={m(styles.projectsGrid, styles.projectsGridMobile)}>
                  {[
                    {
                      tag: "Featured",
                    ...
                    <Reveal key={p.title} rootRef={scrollerRef} y={18}>
                        <div
                          style={m(styles.projectCard, styles.projectCardMobile)}
                        onMouseEnter={(e) => {
              ...
              <div style={styles.skillsWrap}>
                <Reveal rootRef={scrollerRef} y={18}>
                  <div style={styles.skillsInner}>
                    ...
                    <div style={m(styles.skillsGrid, styles.skillsGridMobile)}>
                      {[
                        {
                          ico: "🪟",
                          title: "Windows + Admin",
                        ...
                        <div key={k.title} style={m(styles.skillCard, styles.skillCardMobile)}>
              ...
              <div style={styles.resumeWrap}>
                <div style={m(styles.resumeInner, styles.resumeInnerMobile)}>
                  ...
                  <div style={m(styles.resumeGrid, styles.resumeGridMobile)}>
                    {[{
                      ico: "📡",
                    ...
                    },
                    {
                      ...
                      body:
                        ...
                        <div key={x.title} style={m(styles.expCard, styles.expCardMobile)}>
              ...
              <div style={m(styles.contactWrap, styles.contactWrapMobile)}>
              ...
              <div style={m(styles.reflectionWrap, styles.reflectionWrapMobile)}>
      ...
      <div style={styles.vFooter} aria-label="Site footer">
        <div style={m(styles.vFooterInner, styles.vFooterInnerMobile)}>
          © 2026 Ryan Davis • Built with React, HTML, CSS & a dash of JS
        </div>
      </div>
      {/* simple bottom footer */}
      <footer style={m(styles.footer, styles.footerMobile)}>
        <div style={m(styles.footerInner, styles.footerInnerMobile)}>
...
// Layout constants must be defined outside the styles object for use in style values
const NAV_H = 56;
const TICKER_H = 64;
...
const styles = {
  ...
  scroller: {
    ...
    scrollSnapType: "x mandatory",
    scrollBehavior: "smooth",
    // border: "2px solid red", // DEBUG: make main visible
    // background: "rgba(255,0,0,0.05)", // DEBUG: light red background
  },
    tickerBar: {
      position: "fixed",
  ...
  section: {
    ...
    position: "relative",
    padding: 0,
    // border: "2px solid blue", // DEBUG: make section visible
    // background: "rgba(0,0,255,0.05)", // DEBUG: light blue background
  },
  heroWrap: {
    width: "100%",
    height: "100%",
  ...
  resumeWrapMobile: {
    paddingTop: `calc(${NAV_H}px + 32px)`, // increase top padding
    paddingLeft: 0,
    paddingRight: 0,
    paddingBottom: 0,
